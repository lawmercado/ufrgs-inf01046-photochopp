...
class Ui_view_histogram_matching(object):
    def setupUi(self, view_histogram_matching):
        ...
        self.bt_io_load = QtWidgets.QPushButton(view_histogram_matching)
        self.bt_io_load.setObjectName("bt_io_load")
        self.gridLayout.addWidget(self.bt_io_load, 1, 0, 1, 1)
        self.bt_match = QtWidgets.QPushButton(view_histogram_matching)
        self.bt_match.setEnabled(False)
        self.bt_match.setObjectName("bt_match")
        self.gridLayout.addWidget(self.bt_match, 1, 1, 1, 1)
    ...
    def retranslateUi(self, view_histogram_matching):
        ...
        self.bt_io_load.setText(_translate("view_histogram_matching", "Load image"))
        self.bt_match.setText(_translate("view_histogram_matching", "Match"))
