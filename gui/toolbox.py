...
class Ui_toolbox(object):
    def setupUi(self, toolbox):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -643, 266, 1123))
        ...
        self.transform_bt_rotate = QtWidgets.QPushButton(self.transform_group)
        self.transform_bt_rotate.setEnabled(False)
        self.transform_bt_rotate.setObjectName("transform_bt_rotate")
        self.verticalLayout_4.addWidget(self.transform_bt_rotate)
    ...
    def retranslateUi(self, toolbox):
        ...
        self.transform_bt_rotate.setText(_translate("toolbox", "Rotate 90°"))
